...
namespace Modelo.General.Constantes
{
    public class ConsultasHistoriaClinica
    {
        public const String GUARDA_ORDEN_MEDICA = "";
        public const String LISTAR_PACIENTE = ConstanteGeneral.ESQUEMA_HISTORIA_CLINICA + "uspListadoPaciente";
